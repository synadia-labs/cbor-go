...
func (x *Scalars) MarshalCBOR(b []byte) ([]byte, error) {
	...
	b = cbor.AppendString(b, x.S)
	b = cbor.AppendString(b, "b")
	b = cbor.AppendBool(b, x.B)
	b = cbor.AppendString(b, "i")
	b = cbor.AppendInt(b, x.I)
	b = cbor.AppendString(b, "i8")
	b = cbor.AppendInt8(b, x.I8)
	b = cbor.AppendString(b, "i16")
	b = cbor.AppendInt16(b, x.I16)
	b = cbor.AppendString(b, "i32")
	b = cbor.AppendInt32(b, x.I32)
	b = cbor.AppendString(b, "i64")
	b = cbor.AppendInt64(b, x.I64)
	b = cbor.AppendString(b, "u")
	b = cbor.AppendUint(b, x.U)
	b = cbor.AppendString(b, "u8")
	b = cbor.AppendUint8(b, x.U8)
	b = cbor.AppendString(b, "u16")
	b = cbor.AppendUint16(b, x.U16)
	b = cbor.AppendString(b, "u32")
	b = cbor.AppendUint32(b, x.U32)
	b = cbor.AppendString(b, "u64")
	b = cbor.AppendUint64(b, x.U64)
	b = cbor.AppendString(b, "f32")
	b = cbor.AppendFloat32(b, x.F32)
	b = cbor.AppendString(b, "f64")
	b = cbor.AppendFloat64(b, x.F64)
	...
	b = cbor.AppendTime(b, x.T)
	b = cbor.AppendString(b, "d")
	b = cbor.AppendDuration(b, x.D)
